...
public class ModificarOrigenRuta extends HttpServlet {
            ...
            throws ServletException, IOException
    {
        ...
        bd.ModificarOrigenRuta(idRuta, origen);

        s.setAttribute("accion", "cambiado");
        s.setAttribute("tipo", "origen");
        s.setAttribute("nombre", String.valueOf(origen));
