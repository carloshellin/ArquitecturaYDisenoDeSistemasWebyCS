...
public class ModificarDestinoRuta extends HttpServlet {
            ...
            throws ServletException, IOException
    {
        ...
        bd.ModificarDestinoRuta(idRuta, destino);

        s.setAttribute("accion", "cambiado");
        s.setAttribute("tipo", "destino");
        s.setAttribute("nombre", String.valueOf(destino));
