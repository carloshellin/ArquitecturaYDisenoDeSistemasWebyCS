...
public class FinalizarCompra extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Billete billete = (Billete) s.getAttribute("billete");
        TarjetaBancaria tarjetaBancaria = (TarjetaBancaria) s.getAttribute("tarjetaBancaria");
        ...
        response.sendRedirect(response.encodeRedirectURL("vuelos.jsp"));
    }
